<template ref="searchresult">
  <div class="search-result page-content">
    ...
    <yd-flexbox ref="tabselectMain">
      <yd-flexbox-item><div class="tabselect" @click="showSelect()">资源类别<span :class="{'yd-accordion-rotated': show1}" class="yd-accordion-head-arrow"></span></div></yd-flexbox-item>
      <yd-flexbox-item><div class="tabselect" @click="showRadio()">性别<span :class="{'yd-accordion-rotated': show2}" class="yd-accordion-head-arrow"></span></div></yd-flexbox-item>
    </yd-flexbox>
    <yd-list theme="4">
...
export default {
  ...
  methods: {
    ...
    setBottom() {
      ...
      pe = parseInt(pe.substring(0, pe.length - 2)) + 80
      console.log(pe)
      console.log(allh)
